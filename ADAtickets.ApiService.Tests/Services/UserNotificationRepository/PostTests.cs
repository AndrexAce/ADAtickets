...
namespace ADAtickets.ApiService.Tests.Services.UserNotificationRepository
{
    ...
    public class PostTests
    {
        ...
        public async Task AddUserNotification_ValidEntity_ReturnsUserNotification(UserNotification inUserNotification)
        {
            ...
            List<Notification> notifications = [new Notification { Id = inUserNotification.NotificationId }];
            ...
            UserNotification? addedUserNotification = await mockContext.Object.UserNotifications.SingleOrDefaultAsync(cancellationToken);
        ...
        {
            // Arrange
            List<User> users = [new User { Id = Guid.Empty }];
            List<Notification> notifications = [new Notification { Id = Guid.Empty }];
            List<UserNotification> userNotifications = [new UserNotification { ReceiverUserId = Guid.Empty, NotificationId = Guid.Empty }];
