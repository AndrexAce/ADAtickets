...
/// <summary>
///     Defines a set of methods with annotations (called conventions) that is used to personalize the behavior of the
///     ASP.NET Core API controller.
/// </summary>
[SuppressMessage("Style", "IDE0060:Remove unused parameter",
    Justification =
        "The parameters are not meant to be used, they are only needed to estabilish a pattern to apply the conventions.")]
