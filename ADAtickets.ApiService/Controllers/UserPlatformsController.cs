...
/// <param name="mapper">
///     Object definining the mappings of fields between the <see cref="UserPlatform" /> entity and its
///     <see cref="UserPlatformRequestDto" /> or <see cref="UserPlatformResponseDto" /> correspondant.
/// </param>
...
public sealed class UserPlatformsController(IUserPlatformRepository userPlatformRepository, IMapper mapper)
    : ControllerBase
{
    /// <summary>
    ...
    public async Task<ActionResult<UserPlatformResponseDto>> PutUserPlatform(Guid id,
        UserPlatformRequestDto userPlatformDto)
    {
        ...
        catch (DbUpdateConcurrencyException)
        {
            ...
            if (await userPlatformRepository.GetUserPlatformByIdAsync(id) is null) return NotFound();
    ...
    {
        var userPlatform = mapper.Map<UserPlatform>(userPlatformDto);
        ...
        return CreatedAtAction(nameof(GetUserPlatform), new { id = userPlatform.Id },
            mapper.Map<UserPlatformResponseDto>(userPlatform));
    }
