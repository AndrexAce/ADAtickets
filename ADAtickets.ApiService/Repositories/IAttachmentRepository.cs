...
namespace ADAtickets.ApiService.Repositories
{
    ...
    public interface IAttachmentRepository
    {
        ...
        /// <returns>A <see cref="Task"/> returning the <see cref="Attachment"/> with the given <paramref name="id"/>, or <see langword="null"/> if it doesn't exist.</returns>
        Task<Attachment?> GetAttachmentByIdAsync(Guid id);

        /// <summary>
        /// Gets all <see cref="Attachment"/> entities from the data source asynchronously.
        /// </summary>
        /// <returns>A <see cref="Task"/> returning all the <see cref="Attachment"/> entities, or an empty collection if there are none.</returns>
        ...
        /// </summary>
        /// <param name="filters">Group of key-value pairs representing the criteria to filter the <see cref="Attachment"/> entities.</param>
        /// <returns>A <see cref="Task"/> returning all the <see cref="Attachment"/> entities, or an empty collection if there are none.</returns>
