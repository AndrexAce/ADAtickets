...
public interface IEditRepository
{
    ...
    /// <returns>
    ///     A <see cref="Task" /> returning the <see cref="Edit" /> with the given <paramref name="id" />, or
    ...
    /// </summary>
    /// <returns>
    ///     A <see cref="Task" /> returning all the <see cref="Edit" /> entities, or an empty collection if there are
    ///     none.
    /// </returns>
