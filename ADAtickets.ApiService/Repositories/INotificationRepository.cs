...
public interface INotificationRepository
{
    ...
    /// <returns>
    ///     A <see cref="Task" /> returning the <see cref="Notification" /> with the given <paramref name="id" />, or
    ...
    /// </summary>
    /// <returns>
    ///     A <see cref="Task" /> returning all the <see cref="Notification" /> entities, or an empty collection if there
    ///     are none.
    /// </returns>
    ...
    /// </summary>
    /// <param name="filters">
    ///     Group of key-value pairs representing the criteria to filter the <see cref="Notification" />
    ///     entities.
    /// </param>
    /// <returns>
    ///     A <see cref="Task" /> returning all the <see cref="Notification" /> entities, or an empty collection if there
