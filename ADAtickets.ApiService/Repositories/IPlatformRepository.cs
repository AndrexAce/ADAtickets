...
public interface IPlatformRepository
{
    ...
    /// <returns>
    ///     A <see cref="Task" /> returning the <see cref="Platform" /> with the given <paramref name="id" />, or
    ...
    /// </summary>
    /// <returns>
    ///     A <see cref="Task" /> returning all the <see cref="Platform" /> entities, or an empty collection if there are
    ///     none.
    /// </returns>
    ...
    /// </summary>
    /// <param name="filters">
    ///     Group of key-value pairs representing the criteria to filter the <see cref="Platform" />
    ///     entities.
    /// </param>
    /// <returns>
    ///     A <see cref="Task" /> returning all the <see cref="Platform" /> entities, or an empty collection if there are
