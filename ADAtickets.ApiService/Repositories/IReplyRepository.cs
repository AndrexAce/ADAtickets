...
public interface IReplyRepository
{
    ...
    /// <returns>
    ///     A <see cref="Task" /> returning the <see cref="Reply" /> with the given <paramref name="id" />, or
    ...
    /// </summary>
    /// <returns>
    ///     A <see cref="Task" /> returning all the <see cref="Reply" /> entities, or an empty collection if there are
    ///     none.
    /// </returns>
