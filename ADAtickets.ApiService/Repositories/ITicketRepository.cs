...
public interface ITicketRepository
{
    ...
    /// <returns>
    ///     A <see cref="Task" /> returning the <see cref="Ticket" /> with the given <paramref name="id" />, or
    ...
    /// </summary>
    /// <returns>
    ///     A <see cref="Task" /> returning all the <see cref="Ticket" /> entities, or an empty collection if there are
    ///     none.
    /// </returns>
