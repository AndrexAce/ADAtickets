...
namespace ADAtickets.ApiService.Repositories
{
    ...
    public interface IUserNotificationRepository
    {
        ...
        /// <returns>A <see cref="Task"/> returning the <see cref="UserNotification"/> with the given <paramref name="id"/>, or <see langword="null"/> if it doesn't exist..</returns>
        ...
        /// </summary>
        /// <returns>A <see cref="Task"/> returning all the <see cref="UserNotification"/> entities, or an empty collection if there are none.</returns>
        Task<IEnumerable<UserNotification>> GetUserNotificationsAsync();

        /// <summary>
        /// Gets all <see cref="UserNotification"/> entities from the data source which meet the given criteria asynchronously.
        /// </summary>
        /// <param name="filters">Group of key-value pairs representing the criteria to filter the <see cref="UserNotification"/> entities.</param>
        /// <returns>A <see cref="Task"/> returning all the <see cref="UserNotification"/> entities, or an empty collection if there are none.</returns>
