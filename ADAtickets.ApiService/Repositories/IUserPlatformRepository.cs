...
namespace ADAtickets.ApiService.Repositories
{
    ...
    public interface IUserPlatformRepository
    {
        ...
        /// <returns>A <see cref="Task"/> returning the <see cref="UserPlatform"/> with the given <paramref name="id"/>, or <see langword="null"/> if it doesn't exist..</returns>
        ...
        /// </summary>
        /// <param name="filters">Group of key-value pairs representing the criteria to filter the <see cref="UserPlatform"/> entities.</param>
        /// <returns>A <see cref="Task"/> returning all the <see cref="UserPlatform"/> entities, or an empty collection if there are none.</returns>
