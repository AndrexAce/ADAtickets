...
public interface IUserRepository
{
    ...
    /// <returns>
    ///     A <see cref="Task" /> returning the <see cref="User" /> with the given <paramref name="id" />, or
    ...
    /// </summary>
    /// <returns>
    ///     A <see cref="Task" /> returning all the <see cref="User" /> entities, or an empty collection if there are
    ///     none.
    /// </returns>
