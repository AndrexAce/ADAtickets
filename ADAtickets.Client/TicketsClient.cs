...
namespace ADAtickets.Client
{
    ...
    public sealed class TicketsClient(AuthenticationStateProvider authenticationStateProvider, IDownstreamApi downstreamApi, IConfiguration configuration)
        : Client<TicketResponseDto, TicketRequestDto>(authenticationStateProvider, downstreamApi, configuration)
    {
