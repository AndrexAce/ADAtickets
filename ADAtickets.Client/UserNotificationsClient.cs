...
{
    /// <summary>
    /// Provides methods to interact with ADAtickets UserNotificationsController.
    /// </summary>
    ...
    public sealed class UserNotificationsClient(AuthenticationStateProvider authenticationStateProvider, IDownstreamApi downstreamApi, IConfiguration configuration)
