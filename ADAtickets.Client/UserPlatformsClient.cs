...
/// <summary>
///     Provides methods to interact with ADAtickets UserPlatformsController.
/// </summary>
...
public sealed class UserPlatformsClient(
    ...
    : Client<UserPlatformResponseDto, UserPlatformRequestDto>(authenticationStateProvider, downstreamApi, configuration)
{
    ...
    protected override string ControllerName => Controller.UserPlatforms;
}