...
/// <summary>
///     <para>Represents a ticket compiled via web UI.</para>
///     <para>It is a simplified version of the <see cref="Ticket" /> class, used for data storage on the UI.</para>
/// </summary>
public sealed class TicketFormDto
{
    ...
    /// </summary>
    public string? OperatorUserId { get; set; } = null;
