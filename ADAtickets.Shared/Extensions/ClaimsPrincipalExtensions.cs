...
public static class ClaimsPrincipalExtensions
{
    ...
    /// <returns>
    ///     <see langword="true" /> if the <see cref="ClaimsPrincipal" /> is a DevOps administrator; otherwise,
    ///     <see langword="false" />.
    /// </returns>
    ...
    /// <param name="user">The <see cref="ClaimsPrincipal" /> from which to retrieve the claim.</param>
    /// <returns>
    ///     <see langword="true" /> if the <see cref="ClaimsPrincipal" /> is authenticated; otherwise,
    ///     <see langword="false" />.
    /// </returns>
