...
public sealed class CreateOperatorEditNotificationsAsyncTests
{
    ...
    [Fact]
    public async Task
        CreateOperatorEditNotificationsAsync_OperatorUnassigned_WithNoOperators_CreatesUnassignmentNotificationOnly()
    {
        // Arrange
        var creatorUserId = Guid.NewGuid();
        var editorUserId = Guid.NewGuid();
    ...
    [Fact]
    public async Task
        CreateOperatorEditNotificationsAsync_SamePersonAsCreatorAndNewOperator_CreatesCorrectNotifications()
    {
    ...
    [Fact]
    public async Task
        CreateOperatorEditNotificationsAsync_OperatorAssigned_OldOperatorIsEmptyGuid_CreatesCorrectNotifications()
    {
