...
public sealed class ConfigurationTest
{
    ...
    {
        // Arrange
        var mapper = new MapperConfiguration(cfg => { cfg.AddProfile<ApiServiceAutoMapperProfile>(); }).CreateMapper();
    ...
    {
        // Arrange
        var mapper = new MapperConfiguration(cfg => { cfg.AddProfile<WebAutoMapperProfile>(); }).CreateMapper();
