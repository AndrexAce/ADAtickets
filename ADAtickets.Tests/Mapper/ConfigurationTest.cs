...
namespace ADAtickets.Tests.Mapper
{
    ...
    {
        [Fact]
        public void ValidApiServiceConfiguration_DoesNotThrow()
        {
            // Arrange
            IMapper mapper = new MapperConfiguration(cfg => { cfg.AddProfile<ApiServiceAutoMapperProfile>(); }).CreateMapper();
        ...
        [Fact]
        public void ValidWebConfiguration_DoesNotThrow()
        {
            // Arrange
            IMapper mapper = new MapperConfiguration(cfg => { cfg.AddProfile<WebAutoMapperProfile>(); }).CreateMapper();
