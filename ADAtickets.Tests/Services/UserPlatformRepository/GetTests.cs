...
public sealed class GetTests
{
    ...
    public async Task GetUserPlatformByIdAsync_ExistingId_ReturnsUserPlatform()
    {
        ...
        // Act
        var result = await service.GetUserPlatformByIdAsync(existingId);
    ...
    public async Task GetUserPlatformByIdAsync_NonExistingId_ReturnsNull()
    {
        ...
        // Act
        var result = await service.GetUserPlatformByIdAsync(Guid.NewGuid());
    ...
    public async Task GetUserPlatformByIdAsync_EmptyId_ReturnsNull()
    {
        ...
        // Act
        var result = await service.GetUserPlatformByIdAsync(Guid.Empty);
    ...
    public async Task GetUserPlatforms_EmptySet_ReturnsNothing()
    {
        ...
        // Act
        var result = await service.GetUserPlatformsAsync();
    ...
    public async Task GetUserPlatformsBy_OneFilterWithMatch_ReturnsUserPlatforms()
    {
        ...
        // Act
        var result =
            await service.GetUserPlatformsByAsync([
    ...
    public async Task GetUserPlatformsBy_MoreFiltersWithMatch_ReturnUserPlatforms()
    {
        ...
        // Act
        var result = await service.GetUserPlatformsByAsync([
            new KeyValuePair<string, string>("PlatformId", platformId.ToString()),
    ...
    public async Task GetUserPlatformsBy_NoMatch_ReturnsNothing()
    {
        ...
        // Act
        var result = await service.GetUserPlatformsByAsync([
            new KeyValuePair<string, string>("PlatformId", Guid.NewGuid().ToString())
        ]);
    ...
    public async Task GetAttachmentsBy_InvalidFilter_ReturnsAll()
    {
        ...
        // Act
        var result = await service.GetUserPlatformsByAsync([new KeyValuePair<string, string>("SomeName", "value")]);
