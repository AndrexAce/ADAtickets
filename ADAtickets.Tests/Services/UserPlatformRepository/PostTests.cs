...
namespace ADAtickets.Tests.Services.UserPlatformRepository
{
    ...
    public class PostTests
    {
        ...
        public async Task AddUserPlatform_ValidEntity_ReturnsUserPlatform(UserPlatform inUserPlatform)
        {
            ...
            List<Platform> platforms = [new Platform { Id = inUserPlatform.PlatformId }];
            ...
            UserPlatform? addedUserPlatform = await mockContext.Object.UserPlatforms.SingleOrDefaultAsync(cancellationToken);
        ...
        public async Task AddUserPlatform_InvalidEntity_ReturnsNothing(UserPlatform inUserPlatform)
        {
            ...
            List<Platform> platforms = [new Platform { Id = Guid.Empty }];
            List<UserPlatform> userPlatforms = [new UserPlatform { UserId = Guid.Empty, PlatformId = Guid.Empty }];
