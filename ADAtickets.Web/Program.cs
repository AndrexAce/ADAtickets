...
internal static class Program
{
    ...
    public static void ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        _ = authBuilder.AddMicrosoftIdentityWebApp(builder.Configuration.GetSection(Scheme.OpenIdConnectDefault),
                Scheme.OpenIdConnectDefault, Scheme.CookieDefault)
        ...
        _ = authBuilder.AddMicrosoftIdentityWebApp(
                builder.Configuration.GetSection(Scheme.ExternalOpenIdConnectDefault),
                Scheme.ExternalOpenIdConnectDefault, Scheme.ExternalCookieDefault)
            .EnableTokenAcquisitionToCallDownstreamApi()
        ...
        _ = authBuilder.AddPolicyScheme(Scheme.PolicySchemeDefault, null, options =>
        {
            options.ForwardDefaultSelector = context =>
            {
                ...
                if (authorization is null) return Scheme.OpenIdConnectDefault;

                return authorization.Contains(Scheme.ExternalCookieDefault)
                    ? Scheme.ExternalOpenIdConnectDefault
