...
- You must have an Azure account with permissions to create resource groups with related resources and to manage Microsoft Entra ID settings. I won't cover the steps to gain the adequate permissions here, but you can find more information in the [Microsoft documentation](https://learn.microsoft.com/en-us/azure).
...
- You must have access to Azure DevOps and have linked your Entra ID tenant to your Azure DevOps organization. You can find more information on how to do it in the [Microsoft documentation](https://learn.microsoft.com/en-us/azure/devops/organizations/accounts/connect-organization-to-azure-ad).
...
###### 2.3.2.1.2. Expose APIs and add scopes
...
###### 2.3.2.1.3. Add application roles
...
###### 2.3.2.1.4. Add delegated permissions from Azure DevOps
...
5. Select the following permissions:
	- **vso.code**: Allows the application to read code repositories.
	- **vso.identity**: Allows the application to read user identities.
	- **vso.project**: Allows the application to read project information.
	- **vso.work_write**: Allows the application to create and update work items.
6. Click on **Add permissions** to finalize.
7. Click on **Grant admin consent for [your tenant name]** so that all the permissions can be used without the need of asking to grant them on login.

###### 2.3.2.1.5. Add SSL client certificate
...
###### 2.3.2.2.2. Configure authentication
...
###### 2.3.2.2.3. Add delegated permissions from API app
...
###### 2.3.2.2.4. Add client as trusted to API app
...
###### 2.3.2.2.5. Add SSL client certificate

About the SSL client certificate, you can follow the same steps as above, but you should use a different client certificate from the API one to enforce a greater security.

#### 2.3.3. External tenant setup
...
##### 2.3.3.1. Add user authentication flow
...
##### 2.3.3.2. Optional configuration
